...
const server_1 = __importDefault(require("./server")); // Assuming your express app is exported from server.ts
describe('Currency Service API', () => {
    it('GET /currencies should return a list of supported currencies', async () => {
        const response = await (0, supertest_1.default)(server_1.default).get('/currencies');
